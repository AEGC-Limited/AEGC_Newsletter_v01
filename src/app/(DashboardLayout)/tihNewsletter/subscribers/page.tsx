...
const EnhancedNewsletterSubscriberDashboard = () => {
  ...
  const fetchSubscribers = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/tih-newsletter/subscribers`, {
        method: 'GET',
        headers: {
  ...
  const handleAddSubscriber = async () => {
    try {
      ...
      console.log('API URL:', `${API_BASE_URL}/api/tih-newsletter/subscribers/add`);

      const response = await fetch(`${API_BASE_URL}/api/tih-newsletter/subscribers/add`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const handleUpdateSubscriber = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/tih-newsletter/subscribers/${subscriberToEdit.id}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const handleBulkImport = async () => {
    ...
    try {
      ...
      console.log('API URL:', `${API_BASE_URL}/api/tih-newsletter/subscribers/bulk-import`);

      const response = await fetch(`${API_BASE_URL}/api/tih-newsletter/subscribers/bulk-import`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Accept': 'application/json'
  ...
  const handleDownloadTemplate = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/tih-newsletter/subscribers/download-template`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`
        }
  ...
  const handleDeleteSubscriber = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/tih-newsletter/subscribers/${subscriberToDelete.id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      {editModalOpen && subscriberToEdit && (
        <div className="fixed inset-0 z-50 overflow-y-auto" style={{ pointerEvents: 'auto' }}>
          <div className="fixed inset-0 backdrop-blur-sm bg-bl transition-opacity" onClick={() => setEditModalOpen(false)}></div>
